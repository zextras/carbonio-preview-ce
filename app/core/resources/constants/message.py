...
hard_errors_section_name = "hard_errors"
STORAGE_UNAVAILABLE_STRING = read_message_config(
    section=hard_errors_section_name, value="storage_unavailable_string"
)
GENERIC_ERROR_WITH_STORAGE = read_message_config(
    section=hard_errors_section_name, value="generic_error_with_storage"
)

ITEM_NOT_FOUND = read_message_config(
    section=hard_errors_section_name, value="item_not_found"
)

INPUT_ERROR = read_message_config(section=hard_errors_section_name, value="input_error")

LIBRE_OFFICE_NOT_RUNNING = read_message_config(
